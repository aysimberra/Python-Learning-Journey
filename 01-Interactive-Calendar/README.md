...
* [ ] **GUI Input:** Replace console inputs with `turtle.textinput` for a full graphical user interface experience.
* [ ] **Delete/Edit Notes:** Add functionality to manage existing notes.

---
*Developed by Ayşim Berra as part of the Computer Engineering Python Learning Journey.*